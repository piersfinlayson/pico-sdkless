...
This example provides a complete working tinyusb implementation for the RP2350 without using the Pico SDK.  It is intended to be used as a reference for building tinyusb-based firmware with pico-sdkless.
...
Flash your choice to a RP2350-based board and connect a terminal to the USB CDC port  For example:
